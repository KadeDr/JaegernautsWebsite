    ...
    <div class="Hotlinks">
        ...
        <div>
            ...
            <div class="OurTeam" id="OurTeam" onmouseenter="HoverDropdown(true, 'OurTeam')" onmouseleave="HoverDropdown(false, 'OurTeam')">
                <h3 class="Mentors drop">Mentors</h3>
                <h3 class="Alumni  drop">Alumni</h3>
            </div>
        </div>
        <div>
            ...
            <div class="Sponsors" id="Sponsors" onmouseenter="HoverDropdown(true, 'Sponsors')" onmouseleave="HoverDropdown(false, 'Sponsors')">
                <h3 class="CGT drop">CGT</h3>
                <h3 class="TexasWorkforce drop">Texas Workforce</h3>
                <h3 class="Ventana drop">Ventana</h3>
                <h3 class="Detex drop">Detex</h3>
                <h3 class="Premier drop">Premier Cabinets New Braunfels</h3>
                <h3 class="SweetBites drop">Sweet Bites</h3>
                <h3 class="OakRidge drop">Oak Ridge Bellows</h3>
            </div>
        </div>
        <div>
